...
# Install R packages
RUN R -e "install.packages(c('ggplot2', 'dplyr', 'stringr', 'plotly', 'shinydashboard', 'DT', 'htmlwidgets', 'leaflet', 'shinyBS', 'tidyr', 'forcats', 'shinyjs', 'shinycssloaders', 'httr', 'jsonlite'))"
